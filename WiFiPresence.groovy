 ...
 *
 * 2019-04-16 - Removed every Reference to iPhone and replaced with "WiFi"
 * 2019-04-05 - Changed Referesh Interval to 15 Seconds, Comented out runevery1minute, and added 'unschedule" & "schedule" commands
 */
...
//    runEvery1Minute(refresh)		// Generally test it every minute. /
	unschedule() //Removes any schedules that are in place
	schedule("*/15 * * * * ? *", refresh) // Test it every 15 seconds
